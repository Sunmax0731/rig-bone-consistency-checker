...
- 作業ディレクトリ: `D:\AI\AssetPipeline\rig-bone-consistency-checker`
...
2. `npm run validate` を実行し、`dist/rig-bone-consistency-checker-representative-report.json` が生成されることを確認する。
